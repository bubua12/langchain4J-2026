 ...
 *
 * @author bubua12
 * @since 2026/02/11 19:44
 */
@Service
public class WeatherService {

    private static final String API_KEY = System.getenv("HF_WEATHER_API_KEY");
    ...
    public JsonNode getWeatherV2(String city) throws Exception {
        ...
        System.out.println("jsonNode 响应：" + jsonNode);

        // 6 想知道具体信息和结果请查看 https://dev.qweather.com/docs/api/weather/weather-now/#response
        return jsonNode;
    }
}
